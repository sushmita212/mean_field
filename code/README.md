...
$H=K*\sum_{\langle ij\rangle_{\alpha}}\sigma_i^a\sigma_j^a+\sum+{i}(h^x,h^y,h^z).(\sigma_i^x+\sigma_i^y+\sigma_i^z)+\kappa*\sum_{jlk from cluster R_2,R_I}\sigma_j^a\sigma_k^b\sigma_l^c$
